...
// ------------------    Light          -------------------------
// --------------------------------------------------------------
static const float NIGHT_AMBIENT_BOOST = 1.0f; // can just be baked into the below later ye?
...
static const float3 DayAmbientMapPosY = float3(0.1, 0.1, 0.15);  // kills everything
...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.9f; //2.0f;
...
// Fog of war
static const float 	FOW_MAX 					= 0.70f;
static const float  FOW_CAMERA_MIN				= 000;
static const float  FOW_CAMERA_MAX				= 180;
...
// CAMERA_MIN_HEIGHT = 7.0,					defines.lua   (reload defines)
